...
program
    ...
    .alias('defn') // alternative sub-command is `al`
...
program
    ...
    .alias('syn') // alternative sub-command is `al`
...
program
    ...
    .alias('ant') // alternative sub-command is `al`
...
program
    ...
    .alias('ex') // alternative sub-command is `al`
...
// program
//     .command('play ') // sub-command name
//     .alias('p') // alternative sub-command is `al`
//     .description('Play word guessing game.') // command description
//
//     // function to execute when command is uses
//     .action(function () {
//         // play();
